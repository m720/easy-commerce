...
export default function OrderDetailPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <button onClick={() => navigate("/orders")} className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-6">
      ...
      <div className="bg-white border rounded-xl p-6 mb-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Placed {formatDate(order.created_at)}</p>
          </div>
