    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        >
          ...
          Filters
          {hasFilters && <span className="bg-blue-600 text-white rounded-full text-xs w-4 h-4 flex items-center justify-center">!</span>}
        </button>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 text-gray-500">
          ...
          {hasFilters && <button onClick={clearFilters} className="mt-2 text-blue-600 hover:underline text-sm">Clear filters</button>}
        </div>
      ) : (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
